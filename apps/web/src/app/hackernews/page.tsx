...
import { fetchHackerNewsTrending } from "@/services/trending.service";
      ...
      <section className="bg-gray-50 text-primary py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold">Hacker News Trending</h1>
              <p className="text-gray-300 mt-2">
                Discover the most popular stories on Hacker News right now
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          {loading ? (
            <div className="text-center py-20">
              ...
              <p className="text-gray-600 mt-4">Loading trending stories...</p>
            </div>
          ) : error ? (
